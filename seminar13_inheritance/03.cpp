...
private:
    ...
    Color mDragColor;
public:
    DraggableWithColorChange(Vector2 position, Vector2 size, Color baseColor, Color dragColor): Draggable(position, size, baseColor), mBaseColor(baseColor), mDragColor (dragColor)
    {
    }
    void handleEvents()
    {
...
int main()
{
    ...
    DraggableWithColorChange d {{100, 100}, {200, 400}, {80, 80, 120, 255}, GREEN};
