...
public:
    ...
    std::string get_current_data() {return data[current_index];}
};
...
int main()
{
    ...
    DropList a {{50, 250}, 200, 30, std::vector<const char*> {"Circle", "Square", "Triangle"}};
    ...
    while (!WindowShouldClose())
    {
        ...
        if (a.get_current_data() == "Circle")           {DrawCircleV({600, 300}, 100, GREEN);}
        else if (a.get_current_data() == "Square")      {DrawRectangle(500, 200, 200, 200, GREEN);}
        else if (a.get_current_data() == "Triangle")    {DrawPoly({600, 300}, 3, 100, 30, GREEN);}
